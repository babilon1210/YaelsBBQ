...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      subtext: 'Brisket, short ribs, turkey and chicken - handmade and available every week.',
      ...
      f3_desc: 'Available Thursday & Friday. Orders over ₪1000 unlock any-day delivery.',
    ...
    order: {
      ...
      std_note: 'Order over ₪1000 to unlock any-day delivery (except Saturday).',
  ...
  he: {
    ...
    home: {
      ...
      f2_desc: 'בשר מעושן טוב לא ניתן למהר. כל נתח מלווה מתחילה ועד סוף.',
      f3_title: 'משלוח שבועי',
      f3_desc: 'זמין בחמישי ושישי. הזמנות מעל ₪1000 פותחות אפשרות משלוח בכל יום.',
    ...
    order: {
      ...
      std_note: 'הזמן מעל ₪1000 לפתוח משלוח בכל יום (חוץ משבת).',
